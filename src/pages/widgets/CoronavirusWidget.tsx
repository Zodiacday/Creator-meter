...
const CoronavirusWidget = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-full bg-gradient-to-br from-purple-500/10 to-background p-4 flex items-center justify-center">
  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-purple-500/10 to-background p-4">
      <div className="text-center">
        ...
        <div className="grid grid-cols-2 gap-3 text-left">
          <div>
            ...
            <Counter value={data.global.totalCases} className="text-lg font-bold text-purple-500" />
          </div>
          <div>
