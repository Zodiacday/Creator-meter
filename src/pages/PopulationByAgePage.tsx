  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <MetaTags
        ...
        canonical={`${window.location.origin}/world-population-by-age`}
      />
      <SchemaMarkup
        type="Dataset"
        data={{
          ...
          url: `${window.location.origin}/world-population-by-age`,
      ...
      <SchemaMarkup
        ...
        data={[
          ...
          { name: "Population by Age", url: `${window.location.origin}/world-population-by-age` }
        ]}
      />
      <Navigation />
