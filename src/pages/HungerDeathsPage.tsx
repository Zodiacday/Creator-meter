  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <MetaTags
        ...
        canonical={`${window.location.origin}/how-many-people-die-from-hunger-per-day`}
      />
      <SchemaMarkup
        type="Dataset"
        data={{
          ...
          url: `${window.location.origin}/how-many-people-die-from-hunger-per-day`,
      ...
      <SchemaMarkup
        ...
        data={[
          ...
          { name: "Hunger Deaths Statistics", url: `${window.location.origin}/how-many-people-die-from-hunger-per-day` }
        ]}
      />
      <Navigation />
