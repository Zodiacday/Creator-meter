    ...
    <div className="min-h-full bg-gradient-to-br from-red-500/10 to-background p-4 flex flex-col items-center justify-center">
      <div className="text-center">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <h2 className="text-lg font-bold text-foreground">CO2 Emissions</h2>
        </div>
        <Counter 
          value={co2Emissions} 
          className="text-3xl md:text-4xl font-bold text-red-500 mb-2" 
        />
        <p className="text-xs text-muted-foreground">Metric tons this year</p>
        <a 
...
export default Co2EmissionsWidget;
